...
class TurnProcessor:
    """Applies semantic interpretation. It never writes ContractDraft."""
    ...
    def apply_user_turn(
        ...
        for extracted in interpretation.extracted_signals:
            ...
            changes.append(
                ValueChange(concept=extracted.concept, new=extracted.value, reason="user_signal")
            )
        ...
        for pref in interpretation.preferences:
            ...
            duplicate = any(
                p.concept == pref.concept and p.value == pref.value and p.active
            ...
            if not duplicate:
                ...
                changes.append(
                    ValueChange(concept=pref.concept, new=pref.value, reason="user_preference")
                )
